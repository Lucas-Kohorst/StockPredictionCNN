...
$(document).ready(function() {
    ...
    try {
                        ...
                        try {
                            ...
                            cnn(built.model, tensorData, epochs).then(function(model) {
                                ...
                                predictedValue.data().then(function(predValue) {
                                    ...
                                    $.getJSON("https://api.iextrading.com/1.0/tops/last?symbols=" + company, function(result) {
                                        print("Current price is: " + result[0].price);
                                    });
                                });
        ...
        print("Could not find the selected stock");
    }
